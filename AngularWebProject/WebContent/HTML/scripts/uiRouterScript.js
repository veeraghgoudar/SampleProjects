var app = angular.module("Demo", ["ui.router"])
				 .config(function($stateProvider){
					 $stateProvider
					 			...
					 			//: specofies paramter. :id is the paramter
					 			...
					 			.state("#/uirouter",{
					 				url:"/uirouter",
					 				templateUrl: "HTML/screens/templates/uirouter.html"
					 			})
/*					 			.otherwise({
					 				//redirectTo : "/service"
				 ...
				 .controller("studentDetailsController", function ($scope, $stateParams){
					 ...
					 $scope.studentmessage = "Welcome to Student Details Page";
					 $scope.employeeInfo =  $scope.studentList[$stateParams.id];
